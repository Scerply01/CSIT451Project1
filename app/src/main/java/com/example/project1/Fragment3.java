...
public class Fragment3 extends Fragment {
    private static final String TAG = "q2_Fragment 3";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.q2_fragment3_layout, container, false);

        Log.d(TAG, "onCreateView: Started");

        //initializing variables
        btConfirm = (Button) view.findViewById(R.id.btnConfirm2); //User has confirmed their answer
        radioGroup = (RadioGroup) view.findViewById(R.id.radio_group2);
        radioButton1 = (RadioButton) view.findViewById(R.id.radio_g2_bt1);
        radioButton2 = (RadioButton) view.findViewById(R.id.radio_g2_bt2);
        radioButton3 = (RadioButton) view.findViewById(R.id.radio_g2_bt3);
    ...
    public void checkRadial (){
        ...
        if(radioGroup.getCheckedRadioButtonId() == -1){
            ...
            //Store answer in DB
            ((CardquizActivity)getActivity()).setViewPager(3);
