...
public class Fragment2 extends Fragment {
    private static final String TAG = "q1_Fragment 2";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.q1_fragment2_layout, container, false);

        Log.d(TAG, "onCreateView: Started");

        //initializing variables
        btConfirm = (Button) view.findViewById(R.id.btnConfirm1); //User has confirmed their answer
        radioGroup = (RadioGroup) view.findViewById(R.id.radio_group1);
        radioButton1 = (RadioButton) view.findViewById(R.id.radio_g1_bt1);
        radioButton2 = (RadioButton) view.findViewById(R.id.radio_g1_bt2);
        radioButton3 = (RadioButton) view.findViewById(R.id.radio_g1_bt3);
    ...
    public void checkRadial (){
        ...
        if(radioGroup.getCheckedRadioButtonId() == -1){
            ...
            //Store answer in DB
            ((CardquizActivity)getActivity()).setViewPager(2);
