...
public class Fragment5 extends Fragment {
    private static final String TAG = "q4_Fragment 5";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.q4_fragment5_layout, container, false);

        Log.d(TAG, "onCreateView: Started");

        //initializing variables
        btConfirm = (Button) view.findViewById(R.id.btnConfirm4); //User has confirmed their answer
        radioGroup = (RadioGroup) view.findViewById(R.id.radio_group4);
        radioButton1 = (RadioButton) view.findViewById(R.id.radio_g4_bt1);
        radioButton2 = (RadioButton) view.findViewById(R.id.radio_g4_bt2);
        radioButton3 = (RadioButton) view.findViewById(R.id.radio_g4_bt3);
    ...
    public void checkRadial (){
        ...
        if(radioGroup.getCheckedRadioButtonId() == -1){
            ...
            //Store answer in DB
            ((CardquizActivity)getActivity()).setViewPager(5);
